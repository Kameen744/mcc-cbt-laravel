        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="flex-grow-1">
              ...
              >
                <i class="fas fa-plus-circle"></i> Upload Students
              </button>
            ...
            <div class="container-fluid">
              <div class="row shadow-sm justify-content-center">
                <div class="col-md-auto">
                  <button @click="showModal(Student)" class="btn btn-info btn-sm">
                    <i class="fas fa-edit"></i> Edit
                  </button>
                </div>
                <div class="col-md-auto">
                  <button @click="delStudent(Student.id)" class="btn btn-danger btn-sm">
              ...
              <div class="card-body shadow-sm text-dark">
                ...
                <div class="row">
                  <div
                    class="col-6 border-left-danger shadow-sm"
                  >First Choice: {{Student.first_choice}}</div>
                  <div
                    class="col-6 border-left-danger shadow-sm"
                  >Second Choice: {{Student.second_choice}}</div>
                  ...
                  >Admission No.: {{Student.admission_number}}</div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body overflow-auto px-3 h-auto" ref="uploadContainer">
            ...
            <div class="row">
              <table class="table table-bordered bg-gradient-primary" v-if="uploadForm.students[0]">
                <thead>
                  <tr>
                    <th v-for="(th_col, key) in uploadForm.students[0].slice(0, 6)" :key="key"></th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div class="modal-body">
              <div class="container-fluid">
                ...
                <div class="form-group">
                  <input
                    type="text"
                    v-model="form.o_level_1"
                    name="o_level_1"
                    class="form-control form-control-sm"
                    placeholder="O-Level 1"
                ...
                <div class="form-group">
                  <input
                    type="text"
                    v-model="form.o_level_2"
                    name="o_level_2"
                    class="form-control form-control-sm"
                    placeholder="O-Level 2"
        ...
        <div class="modal-content">
          <div class="modal-header py-1 d-flex justify-content-between">
            ...
            <div class="form-group" v-if="departmentStudents">
              <button type="button" class="btn btn-primary btn-sm" @click="printDoc">
                Print
          ...
          <div
            class="col-12 bg-gradient-primary passwordsArea"
            v-if="departmentStudents"
            ref="passwordsArea"
          >
...
export default {
  ...
  methods: {
    ...
    newStudent() {
      this.$Progress.start();
      this.form.post(`student`).then(res => {
    ...
    uploadStudents() {
      this.uploadForm.post(`student`).then(res => {
    ...
    editStudent() {
      this.$Progress.start();
      this.form.put(`student/${this.form.id}`).then(res => {
