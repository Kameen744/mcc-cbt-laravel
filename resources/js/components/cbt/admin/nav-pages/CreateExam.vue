                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        class="form-control form-control-sm" name="department_id"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group">                                        
                                        <select id="course" @change="addExamCourse" v-model="settingForm.course_id" 
                                        name="course_id">
                                        ...
                                        <select data-toggle="tooltip" title="Section" v-model="settingForm.section_id" id="section">
                                        ...
                                        <input data-toggle="tooltip" title="No. of questions" class="inp-sm" type="number" v-model="settingForm.no_questions">
...
export default {
    ...
    methods: {
        ...
        settingExamModal(exam){
            if(exam){
                this.settingForm.exam_id = exam.id;
                this.exam = exam;
                axios.all([
                    axios.get(`exam/sections/${exam.id}`),
                    axios.get('course')
                ])
                .then(axios.spread((examSectionsRes, coursesRes) => {
        ...
        addCourseSections(){
            this.settingForm.post(`exam/coursesection`)
            .then(res => {
            this.examSections = res.data;
            });
        },
        ...
        delExamSection(id){
            axios.get(`exam/deletesection/${id}`)
            .then(res => {
                this.examSections = res.data;
            })
        }
