    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
          ...
          <data-table :columns="columns" :key="data_table_key" :classes="classes" url="course"></data-table>
        </div>
      </div>
    </div>
            ...
            <div class="container-fluid">
              <div class="row shadow-sm justify-content-center">
                <div class="col-md-auto">
                  <button @click="showModal(course)" class="btn btn-info btn-sm">
                    <i class="fas fa-edit"></i> Edit
                  </button>
                </div>
                <div class="col-md-auto">
                  <button @click="delCourse(course.id)" class="btn btn-danger btn-sm">
...
export default {
  ...
  methods: {
    ...
    newCourse() {
      this.$Progress.start();
      this.form.post(`course`).then(res => {
        this.courses = res.data;
    ...
    editCourse() {
      this.$Progress.start();
      this.form.put(`course/${this.form.id}`).then(res => {
        this.courses = res.data;
        this.updateDataTable();
