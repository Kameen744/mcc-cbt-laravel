        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    :classes="classes" url="get_admins"></data-table>
                </div>
            </div>
        </div>

        <div class="modal swal2-modal swal2-show" id="viewStaff" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                        ...
                        <div class="container-fluid"> 
                            <div class="row shadow-sm justify-content-center">
                                <div class="col-md-auto">
                                    <button @click="showModal(admin)"
                                    class="btn btn-info btn-sm">
                                    <i class="fas fa-edit"></i> Edit</button>
                                </div>
                                <div class="col-md-auto">
                                    <button @click="permissionModal(admin)"
                                    class="btn btn-success btn-sm">
                                    <i class="fas fa-key"></i> Permissions Settings</button>
                                </div>
                                <div class="col-md-auto">
                                    <button @click="delStaff(admin.id)"
