...
Route::get('exam/start_exam/{exam}',
'Cbt\ExamController@start_exam');
...
Route::post('recommendation/{student_id}/{recommend}/{remark}', 'Cbt\ExamController@add_recommendation');
...
Route::get('recommendation_options', 'Cbt\RecommendationController@options');
route::get('get_exam_start_time/{student_id}/{exam}/{status}', 'Cbt\CbtController@get_exam_start_time');
route::get('set_elapse_time/{student_id}/{exam_id}/{time}', 'Cbt\CbtController@set_elapse_time');
route::get('set_exam_finish_time/{student_id}/{exam_id}', 'Cbt\CbtController@set_exam_finish_time');
